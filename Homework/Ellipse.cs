...
namespace Homework {
    class Ellipse {
        ...
        public void Draw(Graphics g) {
            ...
            g.FillEllipse(brush, new System.Drawing.Rectangle(ActualCoords, ActualSize));
            if(Selected) {
                g.DrawEllipse(new Pen(Color.Black), new System.Drawing.Rectangle(ActualCoords, ActualSize));
            }
        }
